package com.imorning.tns.overlay;
...
public class PoiOverlay {
     ...
     *
     * @param amap 地图对象。
     * @param pois 要在地图上添加的poi。列表中的poi对象详见搜索服务模块的基础核心包（com.amap.bean.services.core）中的类<strong> <a href="../../../../../../Search/com/amap/bean/services/core/PoiItem.html" poi_keyword_uri_title="com.amap.bean.services.core中的类">PoiItem</a></strong>。
     * @since V2.1.0
     */
     ...
     *
     * @param index 第几个poi。
     * @return poi的信息。poi对象详见搜索服务模块的基础核心包（com.amap.bean.services.core）中的类 <strong><a href="../../../../../../Search/com/amap/bean/services/core/PoiItem.html" poi_keyword_uri_title="com.amap.bean.services.core中的类">PoiItem</a></strong>。
     */
